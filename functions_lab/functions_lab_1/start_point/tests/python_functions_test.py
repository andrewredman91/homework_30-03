...
#   @unittest.skip("delete this line to run the test")
  ...
  def test_volume_of_cube(self):
        volume_of_cube = cubed_side_length( 2 )
...
#    pass
  ...
  def test_reverse_string(self):
        reverse_string = string_reversed( "Hello world" )
        self.assertEqual( "dlrow olleH", reverse_string )
#    pass

  #Given a value in farenheit, convert this into celsius.
#  @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    fahrenheit_to_celsius = conversionFC( 100 )
    self.assertEqual(37 , fahrenheit_to_celsius )
#    pass
